/* eslint-disable */ 
export function extractValue(type: string, len: number, buffer: Buffer, offset: number): number | string {
	let i1;
	let i2;
	let buf;
...
export function writeValue(type: string, value: number | string): Buffer | undefined {
	let a0;
	let a1;
	let a2;
	let buffer;
